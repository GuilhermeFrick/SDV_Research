...
Este repositório tem como objetivo centralizar os materiais utilizados no desenvolvimento da pesquisa sobre **detecção de anomalias em redes automotivas baseadas em SOME/IP no contexto de Software-Defined Vehicles (SDV)**.
...
├── data/             # Capturas de tráfego, datasets e logs
